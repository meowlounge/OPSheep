	...
	protected RecipeGenerator getRecipeGenerator(RegistryWrapper.WrapperLookup registryLookup, RecipeExporter exporter) {
		return new RecipeGenerator(registryLookup, exporter) {
			...
			public void generate() {
				createShaped(RecipeCategory.MISC, OpSheepItems.SUPER_DYE)
						.pattern("111")
						.pattern("1D1")
						.pattern("111")
				...
				createShaped(RecipeCategory.TOOLS, OpSheepItems.SUPER_SHEAR_V1)
						.pattern("111")
						.pattern("1D1")
						.pattern("111")
				...
				createShaped(RecipeCategory.TOOLS, OpSheepItems.SUPER_SHEAR_V2)
						.pattern("111")
						.pattern("1D1")
						.pattern("111")
				...
				createShaped(RecipeCategory.TOOLS, OpSheepItems.SUPER_SHEAR_V3)
						.pattern("111")
						.pattern("1D1")
						.pattern("111")
				...
				createShaped(RecipeCategory.TOOLS, OpSheepItems.SUPER_SHEAR_V4)
						.pattern("111")
						.pattern("1D1")
						.pattern("111")
				...
				createShaped(RecipeCategory.TOOLS, OpSheepItems.SUPER_SHEAR_V5)
						.pattern("111")
						.pattern("1D1")
						.pattern("111")
